...
It allows artists and developers to objectively evaluate string art algorithms by generating:
...
Connecting nail coordinates
Accumulating brightness where threads overlap
Applying blur to simulate thread thickness
...
Select one or more thread sequence .txt files
...
└── README.md
🧪 Example Workflow
Generate string art sequences using your preferred algorithm.
Save sequence files such as:
800.txt
1200.txt
1600.txt
Run the analyzer and load these files.
